...
:Confirm Docker daemon availability;
:Inspect SOCKS5 tunnel listener on port 1080;
:Test reachability of key third-party APIs;
:Evaluate disk utilization thresholds;
:Output consolidated report and status code;
stop
@enduml
```
